1. **Relation MTM entre une classe racinne et une classe feuille**
...
>               
>       }
- Si je souhaite recupérer un type de Jardinier, par exemple ceux qui ne cultive que des fleurs, je suis obligée d'ajouter une condition sur le type de la classe cible en utilisant **INSTANCE OF**.
